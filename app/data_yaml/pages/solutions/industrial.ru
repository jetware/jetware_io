...
Изоляция работает в операционной системе Yocto Linux, Wind River Linux и в других POSIX-совместимых операционных системах, включая операционные системы реального времени. Требования к вычислительным ресурсам устройства определяются только требованиями приложений и его зависимостей. Изоляция не приносит дополнительных накладных расходов и ее использование сохраняет возможность совместного использованию разными приложениями разделяемых файлов и оперативной памяти, и позволяет эффективно экономить расход ресурсов. 
