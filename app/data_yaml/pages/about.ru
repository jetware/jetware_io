...
Большая часть программ в коллекции Jetware имеет несколько версий или вариантов компиляции. Например, в число пакетов СУБД входят MySQL версий 5.1, 5.5, 5.6 и 5.7, MariaDB версий 5.5, 10.0, 10.1, 10.2 и Percona 5.7, WebScaleSQL; для PHP существуют версии 5.2, 5.3, 5.4, 5.5, 5.6, 7.0, 7.1. Точно так же многие другие серверные программы и библиотеки существуют в нескольких версиях.
...
сервере с CentOS 6, или запустить PHP 5.2 на сервере с Ubuntu 16.04.
